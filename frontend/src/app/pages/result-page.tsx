...
interface ApiProduct {
  ...
  image_url?: string;
  links: { amazon?: string | null; nykaa?: string | null; flipkart?: string | null; product_url?: string | null };
}
              ...
              <div>
                <div className="flex items-center justify-between mb-4 gap-3">
                  ...
                  <button
                    ...
                    aria-label="Remove current image and upload another"
                    title="Remove current image and upload another"
                  >
                    <X className="w-4 h-4" />
                    <span className="text-sm font-medium">Upload Other</span>
                  </button>
                </div>
